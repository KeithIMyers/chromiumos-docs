...
request features for core Chrome OS functionality. (For details on this issue
...
>**Note:** The Chrome OS Public Issue Tracker is intended only for bugs and
feature requests related to core Chrome OS functionality, and is a technical
...
3.  Each bucket includes a number of states that provide more detail on the
fate of the issue.
4.  Bugs marked **_Resolved_** will be included in a future release of Chrome
OS.
***
...
In general, if a bug is in one of the Open states, the Chrome OS team has
...
However, Chrome OS contains a lot of software and gets a correspondingly large
